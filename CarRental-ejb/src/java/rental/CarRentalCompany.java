...
public class CarRentalCompany implements Serializable{
    ...
    public Quote createQuote(ReservationConstraints constraints, String guest)
        ...
        return new Quote(guest, constraints.getStartDate(), constraints.getEndDate(), this, getType(constraints.getCarType()), price);
    }
    ...
    public Reservation confirmQuote(Quote quote) throws ReservationException {
        ...
        List<Car> availableCars = getAvailableCars(quote.getCarType().getName(), quote.getStartDate(), quote.getEndDate());
